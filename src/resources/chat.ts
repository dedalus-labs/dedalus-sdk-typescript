...
export interface CompletionRequest {
  ...
  model?:
    | string
    | Array<string>
    | CompletionRequest.ModelInput
    | Array<CompletionRequest.ModelObjectArray>
    | null;
...
export namespace CompletionRequest {
   ...
   * anonymous union members.
   */
  export interface ModelObjectArray {
    /**
     * Model identifier
     */
    name: string;
...
export interface ChatCreateParamsBase {
  ...
  model?:
    | string
    | Array<string>
    | ChatCreateParams.ModelInput
    | Array<ChatCreateParams.ModelObjectArray>
    | null;
