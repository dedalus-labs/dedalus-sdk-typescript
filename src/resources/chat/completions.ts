...
export interface CompletionRequest {
   ...
   */
  model: ModelID | CompletionRequest.DedalusModel | Models;
 ...
 */
export type Models = Array<ModelID | Models.DedalusModel>;
...
export interface CompletionCreateParamsBase {
   ...
   * choose optimal model based on task complexity.
   */
  model: ModelID | CompletionCreateParams.DedalusModel | Models;
