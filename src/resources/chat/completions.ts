...
export interface ChatCompletionMessage {
   ...
   */
  audio?: ChatCompletionMessage.Audio | null;
...
export interface ChoiceDelta {
   ...
   * - name (optional): str
   */
  function_call?: ChoiceDelta.FunctionCall;
...
export namespace ChoiceDeltaToolCall {
  /**
   * Schema for ChatCompletionMessageToolCallChunkFunction.
   *
   * Fields:
...
export interface StreamChoice {
   ...
   */
  logprobs?: StreamChoiceLogprobs | null;
}
 ...
 * - refusal (required): list[ChatCompletionTokenLogprob]
 */
export interface StreamChoiceLogprobs {
  /**
   * A list of message content tokens with log probability information.
   */
  content: Array<ChatCompletionTokenLogprob> | null;
