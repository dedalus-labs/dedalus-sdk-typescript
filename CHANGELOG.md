...
Full Changelog: [v0.1.0-alpha.9...v0.0.1](https://github.com/dedalus-labs/dedalus-sdk-typescript/compare/v0.1.0-alpha.9...v0.0.1)
...
* add BYOK provider header test coverage ([159ae2c](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/159ae2c3549bfdb8579b216b5be12f3e9e86d940))
* add hybrid RSA-OAEP + AES-GCM credential encryption module ([b407800](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/b407800c5ec951c8ebd144c28de2a348da7c9406))
* add MCP protocol types and wire format serialization ([4fe052a](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/4fe052ada30698afa808c16397ab90d1235601e6))
* add MCP protocol types and wire format serialization ([#20](https://github.com/dedalus-labs/dedalus-sdk-typescript/issues/20)) ([bec7448](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/bec74487352f637fa918de92e0445d783ae4c0db))
...
* **mcp:** add an option to disable code tool ([b5357b6](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/b5357b6304c0c498b3bd0df111f2314905cb40a5))
...
* **docs/contributing:** correct pnpm link command ([a6c274c](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/a6c274c4555f7b0aee2af0ef7f6eef413d706cc2))
...
* fix request delays for retrying to be more respectful of high requested delays ([edb1690](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/edb1690ff3e262b8667f8debc4532c50ed8cc2a4))
* **internal:** skip tests that depend on mock server ([4514661](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/4514661e8956d4591989cb9c94cf61246eb18681))
...
* **mcp:** initialize SDK lazily to avoid failing the connection on init errors ([778cbab](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/778cbabf277d75929d4c5fa44d72a291055cee0c))
...
* **mcp:** update prompt ([217fe32](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/217fe32d07eeda6fdd02ea5ec1852cf06c5d4921))
...
* resolve lint errors for crypto types and Response shadowing ([0c6f205](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/0c6f2056ab799719b370ef094eed210b46447a96))
* resolve remaining lint errors across test files ([5352db1](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/5352db19ee8dfc16323fc7d83aa19666de3dfb13))
* use MCPServerWithCredsProtocol for type-safe credential access ([26cda04](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/26cda04365decc1e2d3ebc13d8560da4f76670e7))
* use MCPServerWithCredsProtocol for type-safe credential access ([#23](https://github.com/dedalus-labs/dedalus-sdk-typescript/issues/23)) ([3ebe6f9](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/3ebe6f9a6d6c41f3a2b246ad2e996b67bcf43267))
...
* **internal/client:** fix form-urlencoded requests ([6f2394d](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/6f2394dc2fb60418bfadf1f2777387b987f9c19e))
...
* **internal:** allow setting x-stainless-api-key header on mcp server requests ([52cd484](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/52cd484c41744a86726fd9b64eb26280fa037f81))
...
* **internal:** avoid type checking errors with ts-reset ([5c5bb68](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/5c5bb6845ff16a6201e036e9e419fc557d616b1b))
* **internal:** cache fetch instruction calls in MCP server ([ffbde42](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/ffbde42e8af40ea0336592863331dcaabdc9cb27))
...
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([c6f35f2](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/c6f35f22cb59b4afcd1233cbb9beeaefea443f92))
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([7020400](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/702040088a98830c93344058ca37078e036ada12))
...
* **internal:** improve layout of generated MCP server files ([602ae0a](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/602ae0ab4d9c2e4a6de562190fe96f4f5ec14a5b))
* **internal:** make MCP code execution location configurable via a flag ([6040586](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/60405867733a1e3bc8ade67570c40668ce3b816d))
...
* **internal:** move stringifyQuery implementation to internal function ([6380aab](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/6380aab1f6551ad2359f118861b36f91dbc52f36))
...
* **internal:** remove mock server code ([d18a96d](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/d18a96d71d9b28a40e80ed7290682c4ed07549a7))
* **internal:** skip test requiring mock server ([969ae52](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/969ae52d9c0b41eefbb4ffe93b3567739c18eb6a))
...
* **internal:** switch MCP servers to use pino for logging ([f69b092](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/f69b092e03fd295224a09bbddf1befa5e256f1b1))
...
* **internal:** upgrade @modelcontextprotocol/sdk and hono ([b79cec6](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/b79cec603f6cd6e59010e13b500e5e2ee758c8f8))
...
* **internal:** use x-stainless-mcp-client-envs header for MCP remote code tool calls ([5c0c712](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/5c0c71232f5178e99de7a7b5640e03e12608fd7d))
...
* **mcp-server:** return access instructions for 404 without API key ([6ee6812](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/6ee6812c4fc00bc48a138ba892e7141d10bd9bb4))
...
* **mcp:** correctly update version in sync with sdk ([a4b428f](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/a4b428f4e31a0b1c95049fdfa1834eff64e547f5))
...
* **mcp:** forward STAINLESS_API_KEY to docs search endpoint ([461b8ed](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/461b8edd1e0209b561880d9a50295ed2bdf97fb6))
...
* update mock server docs ([2117819](https://github.com/dedalus-labs/dedalus-sdk-typescript/commit/2117819e9bbbacf77caac01d621ae6903f830d3b))
